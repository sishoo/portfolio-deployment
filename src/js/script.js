...
for (let i = 0; i < 9; i++) {
    (function (index) {
        loader.load(`assets/planet_models/${planets[index]}.gltf`, (gltf) => {
...
// let aboutMeShip;
// loader.load('assets/ships/aboutMeShip.gltf', (gltf) => {
//     aboutMeShip = gltf.scene;
//     aboutMeShip.visible = false;
//     aboutMeShip.position.set(-9, 0.2, 1);
//     scene.add(aboutMeShip);
// });

// let otherRocket;
// loader.load('assets/ships/otherRocket.gltf', (gltf) => {
//     otherRocket = gltf.scene;
//     otherRocket.visible = false;
//     otherRocket.position.set(0, -8, 0);
//     scene.add(otherRocket);
// });
...
// let moving = false;
// function moveAboutMeShip(targetX, duration, aboutParagraph) {
//     const startX = aboutMeShip.position.x;
...
//         if (progress < 1) {
//             const newPositionX = startX + (targetX - startX) * progress;

//             aboutMeShip.position.x = startX + (targetX - startX) * progress;
            
//             aboutParagraph.style.left = `${newPositionX * window.innerWidth / 2}px`;
...
// function moveOtherRocket(targetY, duration, otherParagraph) {
//     const startY = otherRocket.position.y;
//     const startTime = Date.now();
...
//         const progress = elapsed / duration;
//         if (progress < 1) {
//             const newPositionY = startY + (targetY - startY) * progress;

//             otherRocket.position.y = startY + (targetY - startY) * progress;
            
//             otherParagraph.style.top = `${newPositionY * window.innerHeight / 2}px`;
